...
const SettingsPage: React.FC = () => {
    ...
    return (
        <div className="animate-fade-in" style={{ padding: 28, maxWidth: 860, margin: '0 auto' }}>
            ...
            {/* ── Account ── */}
            <div className="glass-card animate-slide-in" style={{ padding: 28, marginTop: 24, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                        <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#e2e8f0' }}>Account</h2>
                    ...
                    <button
                        ...
                        style={{ padding: '10px 20px', gap: 10 }}
                    >
